...
public class CoordinateTest {
    ...
    public void invalidCoords() {
        new chess23.Coordinate('b',-3);
        new chess23.Coordinate('b',10);
        new chess23.Coordinate('z',-3);
        new chess23.Coordinate('a',0);
        new chess23.Coordinate('6','z');
    }*/
