...
/*ImageIcon i = new ImageIcon("BBishop.png");
    ...
    public class Board extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            int dimRank = chess23.BOARD.FIRST_RANK.getRankVal();
            ...
            chess23.Pieces pieces = new chess23.Pieces();
            ...
            for (int rank = dimension; rank >= dimRank; rank--) {
                ...
                for (int file = 1; file <= dimension; file++) {
                    ...
                    chess23.Coordinate square = new chess23.Coordinate(fileSquare,rank);
                    if (pieces.getPieces().get(square) != null) {
                        chess23.Piece piece = pieces.getPiece(square);
