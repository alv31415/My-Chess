...
public class MovesTest {
    ...
    chess23.Pieces p = new chess23.Pieces();
    HashMap<chess23.Coordinate, chess23.Piece> pieces = p.getPieces();

    chess23.Coordinate coord1 = new chess23.Coordinate('a',1);
    chess23.Coordinate coord2 = new chess23.Coordinate('A',1);
    chess23.Coordinate coord3 = new chess23.Coordinate('c',7);
    chess23.Coordinate coord4 = new chess23.Coordinate('d',5);
    ...
    public void testCoordDifferenceIllegal() {
        ...
        chess23.Coordinate coord5 = new chess23.Coordinate('b',-3);
        chess23.Coordinate coord6 = new chess23.Coordinate('j',6);
    ...
    public void testdestHasDifferentColour() {
        ...
        assertFalse(Moves.destHasDifferentColour(p,pieces.get(coord1),new chess23.Coordinate('b',1)));
