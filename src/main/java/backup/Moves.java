...
public class Moves {
    ...
    public static int[] getCoordDifference (chess23.Coordinate origin, chess23.Coordinate destination) {
    ...
    public static boolean validHorizontal(chess23.Pieces pieces, chess23.Piece piece, chess23.Coordinate destination){

        Objects.requireNonNull(pieces,nullPieces);
        Objects.requireNonNull(piece,nullPiece);
        Objects.requireNonNull(destination,nullCoord);

        if (piece.getName().equals(chess23.ID.PAWN) || piece.getName().equals(chess23.ID.KNIGHT) || piece.getName().equals(chess23.ID.BISHOP))
            return false;
        ...
        if (rankDifference == 0 && fileDifference > 0) {
            for (int i = 1; i < fileDifference; i++) {
                if (tileFull(pieces, new chess23.Coordinate((char) (piece.getCoords().getFile() + i),piece.getCoords().getRank())))
                        return false;
            }
            return true;
        }
    ...
    public static boolean validVertical(chess23.Pieces pieces, chess23.Piece piece, chess23.Coordinate destination) {

        Objects.requireNonNull(pieces,nullPieces);
        Objects.requireNonNull(piece,nullPiece);
        Objects.requireNonNull(destination,nullCoord);

        if (piece.getName().equals(chess23.ID.KNIGHT) || piece.getName().equals(chess23.ID.BISHOP) || piece.getName().equals(chess23.ID.PAWN))
            return false;
        ...
        if (rankDifference > 0 && fileDifference == 0) {
            for (int i = 1; i < rankDifference; i++) {
                if (tileFull(pieces, new chess23.Coordinate(piece.getCoords().getFile(),piece.getCoords().getRank() + i)))
                    return false;
            }
            return true;
        }
    ...
    public static boolean validDiagonal(chess23.Pieces pieces, chess23.Piece piece, chess23.Coordinate destination) {

        Objects.requireNonNull(pieces,nullPieces);
        Objects.requireNonNull(piece,nullPiece);
        Objects.requireNonNull(destination,nullCoord);

        if (piece.getName().equals(chess23.ID.KNIGHT) || piece.getName().equals(chess23.ID.ROOK) || piece.getName().equals(chess23.ID.PAWN))
            return false;
        ...
        if (fileDifference > 0 && fileDifference == rankDifference) {
            for (int i = 1; i < fileDifference; i++) {
                if (tileFull(pieces, new chess23.Coordinate((char) (piece.getCoords().getFile() + i),piece.getCoords().getRank() + i)))
                    return false;
            }
            return true;
        }
    ...
    public static boolean validKnight(chess23.Piece piece, chess23.Coordinate destination) {

        Objects.requireNonNull(piece,nullPiece);
        Objects.requireNonNull(destination,nullCoord);

        if (!piece.getName().equals(chess23.ID.KNIGHT))
            return false;
    ...
    public static boolean validPawn(chess23.Pieces pieces, chess23.Piece piece, chess23.Coordinate destination) {

        Objects.requireNonNull(pieces,nullPieces);
        Objects.requireNonNull(piece,nullPiece);
        Objects.requireNonNull(destination,nullCoord);

        if (!piece.getName().equals(chess23.ID.PAWN))
            return false;
        ...
        if (piece.getColour().equals(chess23.COLOUR.B)) {
    ...
    public static boolean destHasDifferentColour(chess23.Pieces pieces, chess23.Piece piece, chess23.Coordinate destination) {
    ...
    public static boolean updatePieces (chess23.Pieces pieces, chess23.Piece piece, chess23.Coordinate destination) {
