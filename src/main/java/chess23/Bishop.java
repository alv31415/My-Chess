...
public class Bishop extends Piece{
    ...
    /**
     * Produces an ArrayList containing all the raw moves available to a chess23.Bishop within a given board
     * @param pieces the board being played in
     * @return an ArrayList containing all the coordinates produced from the chess23.Move class (all the diagonals)
     */
    @Override
